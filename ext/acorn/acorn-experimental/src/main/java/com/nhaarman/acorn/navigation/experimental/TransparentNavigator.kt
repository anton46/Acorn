...
@ExperimentalTransparentNavigator
abstract class TransparentNavigator(
    ...
    override fun onStart() {
        v("TransparentNavigator", "onStart")
        execute(state.start())
    }

    @CallSuper
    override fun onStop() {
        v("TransparentNavigator", "onStop")
        execute(state.stop())
    }

    @CallSuper
    override fun onDestroy() {
        v("TransparentNavigator", "onDestroy")
    ...
    private sealed class State {
        ...
        class Destroyed : State() {
            ...
            override fun start(): StateTransition {
                w("TransparentNavigator.State", "Warning: Cannot start state after navigator is destroyed.")
                return StateTransition(this)
            }
            ...
            override fun push(scene: Scene<out Container>, data: TransitionData?): StateTransition {
                w("TransparentNavigator.State", "Warning: Cannot push scene after navigator is destroyed.")
                return StateTransition(this)
            }

            override fun pop(): StateTransition {
                w("TransparentNavigator.State", "Warning: Cannot pop scene after navigator is destroyed.")
                return StateTransition(this)
            }

            override fun onBackPressed(): StateTransition {
                w("TransparentNavigator.State", "Warning: Cannot handle onBackPressed after navigator is destroyed.")
                return StateTransition(this)
            }

            override fun finish(): StateTransition {
                w("TransparentNavigator.State", "Warning: Cannot finish navigator after navigator is destroyed.")
                return StateTransition(this)
            }
        }
    }
