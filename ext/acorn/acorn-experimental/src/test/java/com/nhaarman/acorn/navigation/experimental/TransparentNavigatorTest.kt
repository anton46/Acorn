...
internal class TransparentNavigatorTest {
    ...
    private val navigator =
        TestTransparentNavigator(scene1)
    ...
    inner class SavingState {
        ...
        fun `restoring from empty state ignores state`() {
            /* When */
            val result = TestTransparentNavigator(
                scene1,
                NavigatorState()
            )
            result.onStart()
